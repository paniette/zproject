...
# Les routes littérales packs/custom/, packs/upload-zip/, packs/uploaded/ DOIVENT être
# déclarées avant packs/<pack_id>/ sinon "upload-zip", "uploaded", "custom" sont pris pour des IDs.
